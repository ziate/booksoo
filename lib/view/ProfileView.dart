...
import 'package:flutterapp/activity/MyCart.dart';
...
class _ProfileViewState extends State<ProfileView> {
  ...
  getUserDetails() async {
    ...
    isSocialLoginIn = getBoolAsync(IS_SOCIAL_LOGIN);
    firstName = getStringAsync(FIRST_NAME);
    mProfileImage = getStringAsync(PROFILE_IMAGE);
    String mAvatar = getStringAsync(AVATAR);
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: <Widget>[
              ...
              mOption("supermarket.png", "lbl_my_cart").onTap(() {
              ...
              mOption("verified.png", "lbl_terms_conditions").onTap(() {
                redirectUrl(getStringAsync(TERMS_AND_CONDITIONS));
              }),
              mOption("verified.png", "llb_privacy_policy").onTap(() {
                redirectUrl(getStringAsync(PRIVACY_POLICY));
              }),
              GestureDetector(
                child: Row(
                  children: [
              ...
              ).paddingOnly(top: 10, right: 20, left: 20, bottom: 20).visible(isLoginIn),
