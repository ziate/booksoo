    ...
    Widget mainView = Container(
      ...
      child: (mBookList.length < 1)
          ...
          : Column(
              ...
              children: <Widget>[
                Text(keyString(context, "lbl_hello")! + getStringAsync(FIRST_NAME, defaultValue: keyString(context, "lbl_guest")!), style: TextStyle(fontSize: fontSizeMedium, color: appStore.appTextPrimaryColor)),
                        ...
                        children: <Widget>[
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Text(bookDetail.bookName!, overflow: TextOverflow.ellipsis, softWrap: true, textAlign: TextAlign.start, style: TextStyle(color: appStore.textSecondaryColor, fontSize: fontSizeSmall)),
                            ),
                          )
                        ],
                      ),
        ...
        body: Stack(
          ...
          children: [
            (!mIsLoading)
                ? ListView(
                    shrinkWrap: true,
                    children: [if (_sliding == 0) mainView, if (_sliding == 1) getList(downloadedList, context)],
                  )
