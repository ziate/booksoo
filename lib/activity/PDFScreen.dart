  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: Text(
            keyString(context, "lbl_go_to")! +
                " ${appStore.page} / $mTotalPage",
            style: boldTextStyle()),
      ).onTap(() async {
        int? v = await showInDialog(
          ...
          actions: [
            ...
            Text(keyString(context, "lbl_cancel")!,
          ...
          child: EditText(
              hintText: keyString(context, "lbl_enter_page_number"),
              isPassword: false,
              mController: pageCont,
